...
TEXT = {
    "usage": """\
Type magicdispel and a space, drag photos or videos into the terminal,
and press Enter. Run magicdispel --help to see all options.""",
    "help": """\
magicdispel {version}: remove private metadata from photos and videos

Usage: type magicdispel and a space, drag photos or videos into the terminal,
       then press Enter; or: magicdispel photo.jpg screenshot.png video.mov
...
Removes: location, capture time, camera and lens details, author, comments,
         ...
         in videos also GPS tracks, face and motion data, timecode and chapters.
Keeps:   image and video quality (no recompression), sound, orientation, color,
         HDR and Dolby Vision, transparency and animation.
